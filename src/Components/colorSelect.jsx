...
export default function Colors({
  ...
  function myFunction() {
    let kk = document.getElementById("myDropdown").classList.toggle("show");
  }
        ...
        <div className={`${styles.outershelladd} m-auto d-flex`}>
          ...
          <div className={`dropdown`}>
            ...
            <div id="myDropdown" className={`dropdowncontent`}>
              <a onClick={dwn}>Radial</a>
              <hr className={`m-0`} />
              <a onClick={dwn1}>Repeat Radial</a>
              <hr className={`m-0`} />
              <a onClick={dwn2}>Conic</a>
              <hr className={`m-0`} />
              <a onClick={dwn3}>Repeat Conic</a>
            </div>
          </div>
        </div>
      </div>
